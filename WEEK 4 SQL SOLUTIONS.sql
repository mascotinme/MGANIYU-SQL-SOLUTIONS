...
INSERT INTO SELFJOIN(EMPLOYEE_ID, LAST_NAME, FIRST_NAME,
MANAGER_ID, JOB_TITLE, DEPARTMENT)
VALUES (2, "GANIYU", "MUSA", 1, "DEPUTY CEO II", NULL);

INSERT INTO SELFJOIN(EMPLOYEE_ID, LAST_NAME, FIRST_NAME,
MANAGER_ID, JOB_TITLE, DEPARTMENT)
VALUES (2, "KINGS", "JAMES", 1, "DEPUTY CEO I", NULL);
...
INSERT INTO SELFJOIN(EMPLOYEE_ID, LAST_NAME, FIRST_NAME,
MANAGER_ID, JOB_TITLE, DEPARTMENT)
VALUES (6, "MILO", "SWEET", 1, "ASSISTANT MANAGER", 4);
...
OR S.EMPLOYEE_ID > 5
GROUP BY MYJOINS.MANAGER_ID
ORDER BY S.DEPARTMENT_ID > 1 ASC;